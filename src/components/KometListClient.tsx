      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 pt-8">
          <span className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full px-4 py-1.5 mb-4 text-xs font-semibold text-cyan-400">
            ☄️ Edukasi &amp; Kabar Batuan Luar Angkasa
          </span>
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto">
            Analisis sains populer, hasil pelacakan objek melintas dekat Bumi (NeoWs NASA), dan artikel edukasi asteroid real-time.
          </p>
        </div>
        ...
        <div className="bg-slate-900/60 backdrop-blur border border-cyan-900/30 p-4 md:p-6 rounded-2xl mb-8 flex flex-col md:flex-row gap-4 justify-between items-center shadow-lg">
          <input
            type="text"
            placeholder="Cari artikel komet &amp; asteroid..."
            value={searchQuery}
        ...
        {filteredPosts.length === 0 ? (
          <div className="text-center py-20 bg-slate-900/20 border border-dashed border-cyan-950/50 rounded-2xl">
            ...
            <p className="text-gray-300 font-bold text-lg mb-2">Belum ada artikel komet &amp; asteroid</p>
            <p className="text-gray-500 text-sm">
              {posts.length === 0
                ? 'Gunakan menu Admin untuk memicu rilis otomatis artikel komet.'
                    ...
                    {post.image ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          t.src = 'https://placehold.co/600x400/020617/22d3ee?text=Komet+Asteroid';
                        }}
                      />
                    ) : (
