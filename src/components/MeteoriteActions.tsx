...
export default function MeteoriteActions({ meteorite }: MeteoriteActionsProps) {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      setShareUrls({
        ...
        pinterest: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(url)}&media=${encodeURIComponent(meteorite.image_url || '')}&description=${encodeURIComponent(meteorite.name)}&app_id=${pinterestApiKey}`
      });
    }
    return () => {
      if (typeof window !== 'undefined') {
  ...
  const handleDownloadPDF = async () => {
    ...
    styleEl.innerHTML = `
      ...
      #printable-meteorite-content p,
      #printable-meteorite-content blockquote,
      #printable-meteorite-content ul,
      #printable-meteorite-content ol,
      #printable-meteorite-content img,
      #printable-meteorite-content figure,
      #printable-meteorite-content table {
