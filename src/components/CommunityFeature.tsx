...
export default function CommunityFeature() {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-slate-950 via-blue-950/10 to-slate-950 border-t border-cyan-900/10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 text-left">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Apakah Anda menemukan batu unik yang tidak biasa di alam dan ragu apakah itu batuan bumi biasa atau meteorit luar angkasa?
            </p>
            <p className="text-gray-300 mb-8 leading-relaxed">
              Unggah foto batu temuan Anda ke forum diskusi kami dan mintalah penilaian dari para ahli astronomi serta anggota komunitas kami melalui sistem voting interaktif.
            </p>
            <Link 
              href="/forum"
            ...
            >
              <span>🔍</span> Tanyakan di Forum Diskusi
            </Link>
          </div>
                ...
                {user ? (
                  <div className="flex flex-col items-center gap-2">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-gray-200 font-bold text-sm">Selamat Datang, {user.displayName}!</p>
                    </div>
                    <Link href="/forum" className="mt-2 text-xs text-cyan-400 hover:underline">
                      Kunjungi forum diskusi untuk menulis pertanyaan Anda →
                    </Link>
                  </div>
                ) : (
                  <div>
                    <p className="text-gray-400 text-sm mb-4">Masuk menggunakan Akun Google untuk berpartisipasi</p>
                    <button 
                      onClick={handleLogin}
